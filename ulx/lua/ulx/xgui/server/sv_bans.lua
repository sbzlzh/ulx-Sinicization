...
local bans={}
function bans.init()
	ULib.ucl.registerAccess( "xgui_managebans", "superadmin", "允许在 XGUI 中添加,删除和查看禁令.", "XGUI" )

	xgui.addDataType( "封禁", function() return { count=table.Count( ULib.bans ) } end, "xgui_managebans", 30, 20 )
	...
	ulx.addToHelpManually( "Menus", "xgui fban", "<player> - 打开加禁窗口,冻结指定玩家,自动填写Name/SteamID. (say: !fban)" )
	ulx.addToHelpManually( "Menus", "xgui xban", "<player> - 如果指定了玩家,则打开添加禁用窗口并自动填写名称/SteamID. (say: !xban)" )
end
