...
xlib.makecheckbox{ x=10, y=97, w=150, label="显示启动消息", value=xgui.settings.showLoadMsgs, parent=xguipnl }.OnChange = function( self, bVal )
...
xguipnl.outAnim = xlib.makecombobox{ x=225, y=270, w=150, choices={ "淡出","滑动到顶部","向左滑动","向底部滑动","向右滑动" }, parent=xguipnl }
